...
<body>
    ...
    <section class="dashboard">
        ...
        <div class="top">
            ...
            <div class="logo"><img src="zwk.png" alt="logo" style="width: 12%; position: relative; bottom: 25px; right: 44px;">
        <i style="font-size: 24px; position: relative; right: 55px; bottom: 53px; font-weight: 600;">ZeroWaste</i> <b style="color: #06C167; position: relative; bottom: 53px; right: 60px; font-size: 30px;right: 60px; font-size: 26px;">Kitchen</b></div>
             <p class="user"></p>
...
<br>
<canvas id="donateChart" style="width:50%;max-width:400px"></canvas>
...
<script>
      <?php
            ...
            $female=$ro2['count'];
            $male=$row['count'];
            $q3="SELECT count(*) as count FROM food_donations where location=\"Jharkhand\"";
            $res3=mysqli_query($connection, $q3);
            $ro3=mysqli_fetch_assoc($res3);
            $madurai=$ro3['count'];
            $q4="SELECT count(*) as count FROM food_donations where location=\"Bihar\"";
            $res4=mysqli_query($connection, $q4);
            $ro4=mysqli_fetch_assoc($res4);
            $chennai=$ro4['count'];
            $q5="SELECT count(*) as count FROM food_donations where location=\"Goa\"";
...
var xplace=["Jharkhand","Bihar","Goa"];
