...
<body style="    background-color: #06C167;">
    ...
    <form action="" method="post">
      ...
      <input type="text" id="phoneno" name="phoneno" maxlength="10" pattern="[0-9]{10}" required />
        ...
        <label for="district" style="position:relative; top: 22px;">State:</label>
<select id="district" name="district" style="padding:10px; position:relative; top:20px; left:2px;">
